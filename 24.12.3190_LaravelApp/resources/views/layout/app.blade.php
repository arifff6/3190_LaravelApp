        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    @if(isset($categories))
                        <li>
                            <a href="/#events" class="hover:text-white transition font-semibold text-indigo-200">
                                Semua Kategori
                            </a>
                        </li>
                        ...
                        @foreach($categories as $cat)
                            <li>
                                <a href="/?category={{ $cat->slug }}#events" class="hover:text-white transition capitalize">
                                    {{ $cat->name }}
                                </a>
                            </li>
                        @endforeach
                    @else
                        <li><a href="/#events" class="hover:text-white transition">Lihat Kategori</a></li>
                    @endif
                </ul>
            </div>
            <div>
